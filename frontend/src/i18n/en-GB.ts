  ...
  entities: {
    team: {
      ...
      fields: {
        ...
        'image': 'Image',
        'name': 'Name',
        'estVelocityRange': 'Velocity Range',
        'estVelocity': 'Est. Velocity',
        createdAt: 'Created at',
        updatedAt: 'Last Updated at',
        createdAtRange: 'Created Range',
      },
      enumerators: {
    ...
    project: {
      ...
      fields: {
        ...
        'name': 'Name',
        'stories': 'Stories',
        'initialEstimateRange': 'Estimate Range',
        'initialEstimate': 'Intial Estimate',
        createdAt: 'Created at',
    ...
    sprint: {
      ...
      fields: {
        ...
        'endDate': 'End Date',
        'estimatedVelocityRange': 'Est. Velocity Range',
        'estimatedVelocity': 'Estimated Velocity',
        'actualVelocityRange': 'Actual Velocity Range',
    ...
    complexityChange: {
      ...
      menu: 'Complexity Changes',
      exporterFileName: 'complexityChange_export',
      list: {
        menu: 'Complexity Changes',
        title: 'Complexity Changes',
      },
      create: {
      ...
      fields: {
        ...
        'date': 'Date',
        'effortChangeRange': 'Effort Range',
        'effortChange': 'Effort Change',
        'reason': 'Reason',
        createdAt: 'Created at',
        updatedAt: 'Updated at',
        createdAtRange: 'Created at',
    ...
    story: {
      ...
      fields: {
        id: 'Id',
        'backlogPriorityRange': 'Priority Range',
        'backlogPriority': 'Priority',
        'name': 'Name',
        'description': 'Description',
        'effortRange': 'Effort Range',
        'effort': 'Effort',
        'phase': 'Phase',
        'dateAddedRange': 'Added Range',
        'dateAdded': 'Added',
        'status': 'Status',
        'dateFinishedRange': 'Finished Range',
